...
public class INVStatusChange extends BaseClass{
	...
	public void invStatusChange() throws Exception {
		...
		patho1.INVstatushange(visitnum, readconfig.getAuthrizedBy(), readconfig.getAuthrizedBy());

		RolesPage p4 = new RolesPage(driver);
		p4.LabTech(readconfig.getLabTechrole());
		
		LabTechnicianPage l1 = new LabTechnicianPage(driver);
		l1.StatusChangeresultEntry(name, readconfig.getResultentry2());
		...
		PathologistPage patho2 = new PathologistPage(driver);
		patho2.Approval(name);
