...
import com.TestProduct.PageObjects.Batchsheet;
...
public class BatchWise extends BaseClass{

	Readconfig readconfig = new Readconfig();
	HelperClass helper = new HelperClass();
	
	@Test(retryAnalyzer = Zretryclass.class)
	public void batchwiseResult() throws Exception {
...
Thread.sleep(2000);
		...
		Batchsheet b = new Batchsheet(driver);
		b.batch(visit, visit, readconfig.getOrgLocation());
		
		
		String batchNumber = helper.BatchNumber();
		
		
		RolesPage ro = new RolesPage(driver);
		ro.AccessionOrgtoOrg(readconfig.getOrgname(), readconfig.getAccessionrole(), 
				readconfig.getOrgLocation());
		
		
		Batchsheet b1 = new Batchsheet(driver);
		b1.receivebatch(batchNumber);
		...
		Batchsheet b2 = new Batchsheet(driver);
		b2.batchwiseEnterResult(visit, visit, readconfig.getvalue1());
		...
		Batchsheet b3 = new Batchsheet(driver);
		b3.batchwiseResultValidation(visit, visit);
